...
export default function Settings() {
  return (<div><div className="flex items-center justify-between mb-3"><h1 className="text-xl font-bold">Settings</h1><LogoutButton /></div><div className="card text-sm space-y-1">
    ...
    <p><b>Disconnection notice:</b> on the <b>5th</b> of each month, clients with past-due bills get a final SMS/email: "We did not receive any payment — settle now to avoid disconnection on the {process.env.DISCONNECT_DAY ?? 10}th of the month."</p>
