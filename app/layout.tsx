...
export const metadata = {
  ...
  icons: { icon: "/companylogo.jpg", apple: "/icon-192.png" }
};
...
export default function Root({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en"><body>
      <nav className="bg-slate-900 text-white px-4 py-3 flex items-center gap-4 text-sm overflow-x-auto">
        <a href="/" className="flex items-center gap-2 shrink-0">
          <Image src="/companylogo.jpg" alt="Cleantech" width={32} height={32} className="rounded" />
          <b className="whitespace-nowrap">Cleantech ICT Solution Inc</b>
        </a>
