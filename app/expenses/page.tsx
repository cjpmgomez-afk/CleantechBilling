...
export default function Expenses() {
  ...
  return (<div><h1 className="text-xl font-bold mb-3">Expenses</h1>
    <div className="card grid grid-cols-1 sm:grid-cols-4 gap-2 mb-3">
      <select className="input" value={f.category} onChange={e=>setF({...f,category:e.target.value})}><option>Fiber</option><option>Internet Payment</option><option>Salary</option><option>Equipment</option><option>Rent</option><option>Load</option><option>Others</option></select>
    ...
    <div className="card overflow-auto"><table className="table"><thead><tr><th>Date</th><th>Category</th><th>Amount</th><th>Notes</th></tr></thead>
